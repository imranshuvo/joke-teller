...
function textToVoice(text){
    VoiceRSS.speech({
        key: '4256eeda58694ada9bdf4918b55865d8',
        src: text,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
button.addEventListener('click',() => {
    getJoke();
    if(jokeText && jokeText !== ''){
        textToVoice(jokeText);
    }else{
        textToVoice('Something went wrong! Try again perhaps ? Or are you using Internet Exploerer');
    }
